      ...
      <div className="mt-20  grid cols-1 md:grid-cols-5 gap-4 md:auto-rows-[25rem] max-w-7xl mx-auto">
        <Card className="flex flex-col justify-between md:col-span-3">
          ...
          <CardContent className="h-40">
            <CardTitle>One Click Start</CardTitle>
            <CardDescription>
              Start designing in one click — no signups, no confusion.
            </CardDescription>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            <CardTitle>Intuitive by Design</CardTitle>
            <CardDescription>
              Built to feel familiar. No steep learning curves — just create and
              go.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            ...
            <CardDescription>
              No heavy editors. No lags. Your browser stays happy — even with 15
              tabs open.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
        ...
        <Card className="flex flex-col justify-between md:col-span-3">
          <CardContent className="h-40">
            <CardTitle>Simple. Fast. Repeatable.</CardTitle>
            <CardDescription>
              Thumbnail creation you'll actually enjoy.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <div className="w-full h-full p-4 rounded-lg bg-neutral-100 border border-neutral-200 dark:bg-neutral-800 dark:border-neutral-700 ml-6 mt-2">
